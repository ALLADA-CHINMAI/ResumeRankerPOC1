...
OPENAI_DEPLOYMENT      = os.getenv("OPENAI_DEPLOYMENT_NAME", "LnD-gpt-4o")
OPENAI_API_KEY         = os.getenv("OPENAI_API_KEY")
EMBEDDING_DEPLOYMENT   = os.getenv("EMBEDDINGS_OPENAI_DEPLOYMENT_NAME", "text-embedding-3-small")
...
def get_resume_search():
    ...
    if _resume_search_singleton is None:
        from src.common.search import DocumentSearchClient  # local import avoids circular dep at module load
